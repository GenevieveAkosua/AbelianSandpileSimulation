...
TRIALS = 1
serial_folder = "path/to/serial/folder"
parallel_folder = "path/to/parallel/folder"
io_pairs = [("input1.csv", "output1.csv"), ("input2.csv", "output2.csv")]  # Add your input-output pairs
